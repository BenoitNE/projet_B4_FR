...
public class ComptabiliteDaoImpl extends AbstractDbConsumer implements ComptabiliteDao {
    ...
    /** SQLgetLastValueSequenceEcritureComptableByYear */
    private static String SQLgetLastValueSequenceEcritureComptableForYear;
    public void setSQLgetLastValueSequenceEcritureComptableForYear(String pSqLgetLastValueSequenceEcritureComptableforYear) {
        SQLgetLastValueSequenceEcritureComptableForYear = pSqLgetLastValueSequenceEcritureComptableforYear;
    }
    ...
    public SequenceEcritureComptable getLastValueSequenceEcritureComptableForYear(String pJournalCode, Integer pAnnee) throws NotFoundException {
        ...
        try {
            ...
            throw new NotFoundException("Sequence écriture comptable non trouvée : année=" + pAnnee + " code journal=" + pJournalCode);
        }
        return vBean;
    }
    ...
    @Override
    public void insertSequenceEcritureComptable(int pAnnee, int pDerniereValeur, String pJournalCode) {
        NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
        MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
        vSqlParams.addValue("annee", pAnnee);
    ...
    @Override
    public void updateSequenceEcritureComptable(int pAnnee, int pDerniereValeur, String pJournalCode) {
        NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
        MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
        vSqlParams.addValue("annee", pAnnee);
        vSqlParams.addValue("derniere_valeur", pDerniereValeur);
    ...
    @Override
    public void deleteSequenceEcritureComptable(Integer annee, String journalCode) {
